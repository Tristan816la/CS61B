...
public class IntListTest {
    ...
    public void testReverse(){
        IntList A = IntList.of(1, 2, 3);
        IntList B = IntList.of(4, 5, 6);
        IntList rA = IntList.of(3, 2, 1);
        IntList rB = IntList.of(6, 5, 4);
        IntList Atemp = IntList.reverse(A);
        IntList Btemp = IntList.reverse(B);
        assertEquals(Atemp, rA);
        assertEquals(Btemp, rB);
    }
