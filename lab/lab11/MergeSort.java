...
public class MergeSort {
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
            Queue<Item> items) {
        Queue<Queue<Item>> allItemQ = makeSingleItemQueues(items);
        while (allItemQ.size() != 1) {
            allItemQ.enqueue(mergeSortedQueues(allItemQ.dequeue(), allItemQ.dequeue()));
        }
        return allItemQ.peek();
    }
}
