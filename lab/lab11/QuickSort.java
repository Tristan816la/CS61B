...
public class QuickSort {
    ...
    public static <Item extends Comparable> Queue<Item> quickSort(
        ...
        Queue<Item> large = new Queue<>();
        partition(items, getRandomItem(items), less, equal, large);
        less = quickSort(less);
        equal = quickSort(equal);
        large = quickSort(large);
        Queue<Item> smallEqual = catenate(less, equal);
        items = catenate(smallEqual, large);
        return items;
    }
}
